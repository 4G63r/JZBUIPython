...
class MinePage:
    ...
    def get_friend_button_element(self):
        """获取好友元素信息"""
        return self.wait_element('mine_element', 'friend_button')

    def get_collect_button_element(self):
        """获取收藏元素信息"""
        return self.wait_element('mine_element', 'collect_button')

    def get_notice_button_element(self):
        """获取消息元素信息"""
        return self.wait_element('mine_element', 'notice_button')

    def get_sign_button_element(self):
        """获取签到元素信息"""
        return self.wait_element('mine_element', 'sign_button')

    def get_onePrice_button_element(self):
        """获取一元购课元素信息"""
        return self.wait_element('mine_element', 'onePrice_button')

    def get_myCourse_button_element(self):
        """获取我的课程元素信息"""
        return self.wait_element('mine_element', 'myCourse_button')

    def get_inviteReward_button_element(self):
        """获取邀请奖励元素信息"""
        return self.wait_element('mine_element', 'inviteReward_button')

    def get_welfare_button_element(self):
        """获取福利中心元素信息"""
        return self.wait_element('mine_element', 'welfare_button')

    def get_ad_button_element(self):
        """获取广告元素信息"""
        return self.wait_element('mine_element', 'ad_button')

    def get_childInfo_button_element(self):
        """获取孩子档案元素信息"""
        return self.wait_element('mine_element', 'childInfo_button')
    ...
    def get_showcaseView_button_element(self):
        """获取我的发表元素信息"""
        return self.wait_element('mine_element', 'showcaseView_button')

    def get_courseOrder_button_element(self):
        """获取课程订单元素信息"""
        return self.wait_element('mine_element', 'courseOrder_button')
    ...
    def get_growthRecord_button_element(self):
        """获取成长记录元素信息"""
        return self.wait_element('mine_element', 'growthRecord_button')
    ...
    def get_browseHistory_button_element(self):
        """获取浏览记录元素信息"""
        return self.wait_element('mine_element', 'browseHistory_button')

    def get_historyPush_button_element(self):
        """获取历史推送元素信息"""
        return self.wait_element('mine_element', 'historyPush_button')
    ...
    def get_help_feedback_button_element(self):
        """获取帮助与反馈元素信息"""
        return self.wait_element('mine_element', 'help_feedback_button')

    def get_setting_button_element(self):
        """获取设置元素信息"""
        return self.wait_element('mine_element', 'setting_button')
